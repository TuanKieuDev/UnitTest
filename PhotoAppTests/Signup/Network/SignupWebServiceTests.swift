...
//  PhotoAppTests
//
//  Created by kieu.anh.tuanb on 02/04/2024.
...
final class SignupWebServiceTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        signFormRequestModel = SignupFormRequestModel(firstName: "Tuan", lastName: "Kieu", email: "tuan@test.com", password: "12345678")
    ...
    func testSignupWebservice_WhenEmptyURLStringProvided_ReturnsError()  {
        ...
        sut.signup(withForm: signFormRequestModel) { signupResponseModel, error in
            ...
            XCTAssertNil(signupResponseModel, "When an invalidRequestString takes place, the response model must be nil")
            expectation.fulfill()
        }
    ...
    func testSignupWebService_WhenURLRequestFails_ReturnsErrorMessageDescription() {
        ...
        sut.signup(withForm: signFormRequestModel) { (signupResponseModel, error) in
            ...
            XCTAssertEqual(error, SignupError.failedRequest(description: errorDescription), "The signup() method did not return an expected error for an failed request")
